...
export class TeleportController {
  ...
  constructor() {
    ...
    this.triggerBoxUp = new TriggerBox(
      Vector3.create(lobbyCenter.x, lobbyCenter.y, lobbyCenter.z),
      Vector3.create(6, 4.5, 6),
      () => {
        movePlayerTo(
    ...
    this.triggerBoxDown = new TriggerBox(
      Vector3.create(lobbyCenter.x, lobbyCenter.y + 8, lobbyCenter.z),
    ...
    this.triggerBoxFallCheck = new TriggerBox(
      Vector3.create(lobbyCenter.x, lobbyCenter.y + 90, lobbyCenter.z),
      Vector3.create(6, 10, 6),
      () => {
        sfx.lobbyMusicSource.playing = false
        sfx.lobbyAmbienceSource.playing = false
    ...
    this.beamFireSound.addComponent(
      new Transform({
        //position: Vector3.create(lobbyCenter.x, lobbyHeight+40, lobbyCenter.z-7)
