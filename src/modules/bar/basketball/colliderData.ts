...
export let colliderData:CANNON.Body[] = [
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x + 32, 20, barOffset.z + 38 ), 
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +24.5, 0.5, barOffset.z + 48 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +39, 0.5, barOffset.z + 47.6), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
        shape: new CANNON.Cylinder( 1.5, 1.5, 1.5, 12)   ,
        fixedRotation:true 
        //shape: new CANNON.Box(new CANNON.Vec3(barOffset.x +4,40,4))   
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +22.3, 0.5, barOffset.z + 33.9 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
        shape: new CANNON.Cylinder( 1.5, 1.5, 1.5, 12)   ,
        fixedRotation:true 
        //shape: new CANNON.Box(new CANNON.Vec3(barOffset.x +4,40,4))   
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +41, 0.5, barOffset.z + 33.58), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
        shape: new CANNON.Cylinder( 1.5, 1.5, 1.5, 12)   ,
        fixedRotation:true 
        //shape: new CANNON.Box(new CANNON.Vec3(barOffset.x +4,40,4))   
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +19, 10, barOffset.z + 39.65 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +19, 0.25, barOffset.z + 39.65 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +45, 10, barOffset.z + 39.65 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
        shape: new CANNON.Cylinder( 1.9, 1.9, 20, 12)   ,
        fixedRotation:true 
        //shape: new CANNON.Box(new CANNON.Vec3(barOffset.x +4,40,4))   
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +45, 0.25, barOffset.z + 39.65 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
        shape: new CANNON.Cylinder( 2.9, 2.9, 0.5, 12)   ,
        fixedRotation:true 
        //shape: new CANNON.Box(new CANNON.Vec3(barOffset.x +4,40,4))   
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +32, 0.5, barOffset.z + 25.8 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +32, 4, barOffset.z + 25.8 ), 
        quaternion: new CANNON.Quaternion(quat90.x, quat90.y, quat90.z, quat90.w),
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +32, 0, barOffset.z + 58 ), 
        shape: new CANNON.Box(new CANNON.Vec3(10,0.75,4))    
    }),
    //BOOTH PILLAR LEFT1
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +21.5, 0.5, barOffset.z + 23.5 ), 
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +15.6, 0.5, barOffset.z + 29.08 ), 
    ...
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +43.5, 0.5, barOffset.z + 23.5 ), 
        shape: new CANNON.Box(new CANNON.Vec3(1.4,1.2,2.4)),   
        quaternion: new CANNON.Quaternion(quat45.x, quat45.y, quat45.z, quat45.w), 
    }),
    //BOOTH PILLAR RIGHT2
    new CANNON.Body({
        mass: 0, // kg
        position: new CANNON.Vec3(barOffset.x +47.8, 0.5, barOffset.z + 29.08 ), 
        shape: new CANNON.Box(new CANNON.Vec3(2.4,1.2,1.4)),   
        quaternion: new CANNON.Quaternion(quat45.x, quat45.y, quat45.z, quat45.w), 
    }),
   ]