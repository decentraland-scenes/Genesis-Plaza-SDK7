...
const ronYesDialog = 2
const ronNoDialog = 1
const ronBlockchainDialog = 6
const ronNoChainDialog = 7
// --- Shell Dialog (Ron) ---
export let RonDialog: npc.Dialog[] = [
  {
    text:
    ...
    isQuestion: true,
    buttons: [
      { label: 'YES', goToDialog: ronYesDialog },
      { label: 'NO', goToDialog: ronNoDialog },
    ],
  },
  {
    name: 'no',
    ...
    triggeredByNext: () => {
      ...
      // ron.endInteraction()
      //npc.playAnimation(ron,'Goodbye', true, 2 )
    },
    isEndOfDialog: true,
  },
  {
  ...
  },
  {
    ...
    isQuestion: true,
    buttons: [
      { label: 'YES', goToDialog: ronBlockchainDialog },
      { label: 'NO', goToDialog: ronNoChainDialog },
    ],
  },
  {
    name: 'blockchain',
...
const bobYesDialog = 2
const bobNoDialog = 1
//--- Whale Dialog (Bob) ---
export let BobDialog: npc.Dialog[] = [
  {
    text:
    ...
    isQuestion: true,
    buttons: [
      { label: 'YES', goToDialog: bobYesDialog },
      { label: 'NO', goToDialog: bobNoDialog },
    ],
  },
  {
    name: 'no',
